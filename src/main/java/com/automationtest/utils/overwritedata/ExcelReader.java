...
import com.automationtest.utils.exceptions.ExcInvalidArgument;
...
public class ExcelReader {
        ...
        if (row == null) {
            ...
            if (validateCellType(sheet, cell)) {
                if (cell.getCellType() == CellType.STRING) {
                    ...
                    throw new ExcInvalidArgument(ERROR_CELL_TYPE_NOT_RECOGNIZED);
                }
            }
        }
    ...
    public static String getSheetName(String excelFilePath) {
        ...
        if (excelFilePath.trim().contains("..")) {
            ...
            log.error(ERROR_EXCEL_TAB_NOT_DECLARED + excelFilePath);
        }
        return sheetName;
    }
    ...
    public static String getPathFile(String excelFilePath) {
        ...
        if (excelFilePath.trim().contains("..")) {
            ...
            log.error(ERROR_EXCEL_PATH_NOT_DECLARED + excelFilePath);
        }
        return path;
    }
}
